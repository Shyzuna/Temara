...
$demandes = DemandeInfosTable::getDemandesInfos();
...
<body>
	<div id="corps">
		...
		<div id="ensemble">
			...
			<div id="menu_admin">
				<ul>
					<li><a href="consult_demandes_infos.php" class="page_admin_actuelle">Demandes d'informations</a></li>
				...
				<table class="table">
					...
					<tbody>
						...
						foreach ($demandes as $demande)
						{
							...
							if ($demande->demandeVisite)
								echo '<strong>Visite souhaitée</strong><br /><br />';
							if ($demande->commentaire != "")
								echo '<strong>Commentaire : </strong><span class="commentaire_client">'.$demande->commentaire.'</span>';
							else
	...
	<script type="text/javascript" src="js/fonctions_consult_demandes_infos.js"></script>
